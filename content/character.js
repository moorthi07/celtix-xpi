...
function init () {
  ...
  panel.formName        = 'character';
  panel.typeURI         = Cx.NS_CX + 'Cast';
  panel.nameSet         = top.autotext.chars;
  ...
  panel.noRecsMsg       = document.getElementById("celtx-bundle").
                            getString("NoCharactersFound");
  // panel.noRecsMsg       = "No characters found.";   // XXX i18n
